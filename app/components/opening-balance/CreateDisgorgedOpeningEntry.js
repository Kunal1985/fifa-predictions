...
class CreateDisgorgedOpeningEntry extends Authentication {
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div className="form-group">
                                      ...
                                      <Text field='brand' placeholder='Brand Name' className="form-control" />
                                    </div>
                                  </div>
                                </div>
                                <div className="row">
...
export default CreateDisgorgedOpeningEntry;