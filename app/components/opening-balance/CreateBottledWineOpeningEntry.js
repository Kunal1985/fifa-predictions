                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div className="form-group">
                                      <label>Date</label>
                                      <Text field='createBottledWineOpeningDate' placeholder='Date' className="form-control" type="date" />
                                    </div>
                                  </div>
                                </div>
                                <div className="row">
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div className="form-group">
                                      ...
                                      <Text field='createBottledWineOpeningQuantity' placeholder='Quantity' className="form-control" />
                                    </div>
                                  </div>
                                </div>
                                <div className="row">
