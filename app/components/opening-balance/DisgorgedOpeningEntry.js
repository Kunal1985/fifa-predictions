...
class DisgorgedOpeningEntry extends Authentication {
    constructor(props) {
        super(props);
        this.modelName = "DisgorgedDetails";
    ...
    redirectToCreate() {
        ...
        browserHistory.push("/createDisgorgedOpening");
    }

    redirectToEdit(currId) {
      let currProps = this.props;
      browserHistory.push({
        pathname: "/createDisgorgedOpening",
        state: {
          upsertAction: "update",
          id: currId
        }
    ...
    render() {
      ...
      const columns = [{
        ...
        Header: 'Bottle Size',
        accessor: d => d.bottleSize, // Custom value accessors!
        filterMethod: (filter, rows) =>
          matchSorter(rows, filter.value, { keys: ["bottleSize"] }),
        filterAll: true
      }, {
        ...
        return (
            <div className="container">
              <div className="register-heading">Disgorged Details</div>
...
export default DisgorgedOpeningEntry