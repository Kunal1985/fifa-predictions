...
class TirageOpeningEntry extends Authentication {
    constructor(props) {
        super(props);
        this.modelName = "TirageDetails";
    ...
    redirectToCreate() {
        ...
        browserHistory.push("/createTirageOpening");
    }

    redirectToEdit(currId) {
      let currProps = this.props;
      browserHistory.push({
        pathname: "/createTirageOpening",
        state: {
          upsertAction: "update",
          id: currId
        }
      ...
      const columns = [{
        ...
        return (
            <div className="container">
              <div className="register-heading">Tirage Details</div>
...
export default TirageOpeningEntry