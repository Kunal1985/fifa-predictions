...
class CreateVintage extends Authentication {

    constructor(props) {
        super(props);
        this.modelName = "VintageMaster";
      ...
      let currRecord = currState ? currState.currRecord : null;
        return (
            <div className="container">
              <div className="register-heading">Vintage</div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div className="form-group">
                                      ...
                                      <Text field='harvestYear' placeholder='Harvest Year' className="form-control" type="date"/>
                                    </div>
                                  </div>
                                </div>
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div className="form-group">
                                      <label>Fruit Variety</label>
                                      <Text field='variety' placeholder='Fruit Variety' className="form-control" />
                                    </div>
                                  </div>
                                </div>
                                <div className="row">
