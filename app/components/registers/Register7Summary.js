                  ...
                  <tbody>
                    { currRecords ? currRecords.map((currRecord, index) => (
                          <tr key={ currRecord._id }>
                            ...
                            <td>
                              { currRecord.verified ? <span className="verified">Verified</span> : <span className="unverified">Unverified</span> }
                            </td>
                          </tr>
                      )) : "" }
                  </tbody>
