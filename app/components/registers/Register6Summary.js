...
class Register6Summary extends Authentication {
  ...
  render() {
    ...
    const columns = [{
      ...
      id: 'wineVariety', // Required because our accessor is not a string
      Header: 'Wine Variety',
      accessor: d => d.wineVariety, // Custom value accessors!
      filterMethod: (filter, rows) =>
        matchSorter(rows, filter.value, { keys: ["wineVariety"] }),
      filterAll: true
    }, {
