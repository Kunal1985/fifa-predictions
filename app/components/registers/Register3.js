                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div className="form-group">
                                      ...
                                      <Text field='fermentationLoss' placeholder='Fermentation Loss' className="form-control" type="number" />
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div id="dynamicOpeningInput" className="form-group">
                                      <label>Opening Balance</label>
                                      { currState.openings.map(input => <Text placeholder='Opening Balance' className="form-control" field={ input } disabled="disabled" />) }
                                    </div>
                                  </div>
                                  <div className="col-lg-4 col-md-4 col-sm-12">
