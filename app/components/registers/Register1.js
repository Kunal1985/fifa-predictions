    ...
    render() {
        ...
        return (
            <div className="container">
              ...
              <Form defaultValues={ thisVar.state ? thisVar.state.currRecord ? thisVar.state.currRecord : {} : {} } onSubmit={ (values) => {
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12">
                                    <div className="form-group">
                                      ...
                                      <Text field='grapeVariety' placeholder='KG' className="form-control" />
                                    </div>
                                  </div>
                                </div>
                                <div className="row">
