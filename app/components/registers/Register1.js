...
class Register1 extends Authentication {
    ...
    componentDidMount(){
      console.log(this.modelName, "componentDidMount");
    ...
    componentDidUpdate(){
      console.log(this.modelName, "componentDidUpdate");
    }
                              ...
                              <div className="row">
                                <div className="button-section text-center">
                                  <div className="text-center">
                                    <button className="btn btn-primary" type="button" onClick={ thisVar.goBack }>
                                      Back
                                    </button>
                                  </div>
                                  <div className="text-center">
