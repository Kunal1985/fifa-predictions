...
module.exports = function(app) {
   ...
   * Upsert Register2
   */
  app.post('/upsertRegister2', isLoggedIn, function(req, res, next) {
   ...
   * Get Register2
   */
  app.get('/getRegister2', isLoggedIn, function(req, res, next) {
   ...
   */
  app.post('/getRegister2Record', isLoggedIn, function(req, res, next) {
