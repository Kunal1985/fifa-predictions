...
module.exports = function(app) {
   ...
   * Upsert Register3
   */
  app.post('/upsertRegister3', isLoggedIn, function(req, res, next) {
   ...
   * Get Register3
   */
  app.get('/getRegister3', isLoggedIn, function(req, res, next) {
   ...
   */
  app.post('/getRegister3Record', isLoggedIn, function(req, res, next) {
