...
module.exports = function(app) {
   ...
   * Upsert Register9
   */
  app.post('/upsertRegister9', isLoggedIn, function(req, res, next) {
   ...
   * Get Register9
   */
  app.get('/getRegister9', isLoggedIn, function(req, res, next) {
   ...
   */
  app.post('/getRegister9Record', isLoggedIn, function(req, res, next) {
